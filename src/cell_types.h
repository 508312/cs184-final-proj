...
CELL(LAVA, PROPERTY_EMPTY, updateLava) \
...
CELL(LAVA_SPAWNER, PROPERTY_EMPTY, updateLavaSpawner) \
CELL(STONE_SPAWNER, PROPERTY_EMPTY, updateStoneSpawner) \
CELL(TOPGRASS_SPAWNER, PROPERTY_EMPTY, updateTopGrassSpawner)
